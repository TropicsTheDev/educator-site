...
const { data: testimonials } = useSanityQuery(teachingTestimonialsQuery, {
  discipline: "bjj",
});
...
const irmSteps = [
  {
    ...
    description:
      "No lecture. No demonstration. We begin with a specific, live scenario — a game that highlights exactly where you feel stuck. Maybe it's maintaining guard while your partner tries to pass with a specific constraint. Maybe it's escaping a bad position with limited grips.",
    aside:
      "This isn't about failure. It's about creating an honest starting point so we know precisely what we're solving together.",
  },
  {
    stepNumber: 2,
    title: "We Explore Your Experience",
    description:
      "We pause and reflect. I'll ask: What did you feel? What were you trying to do? What stopped you? This step builds awareness. It helps us move from \"I got passed\" to understanding the deeper cues and sensations that led there. And awareness, as you'll discover, is the first step to gaining control.",
  },
  {
    stepNumber: 3,
    title: "We Introduce a Clear, Useful Tool",
    description:
      "With the real problem identified, I offer a focused \"anchor\" — a principle, a detail, or a short sequence. This isn't a rigid rule to obey forever. It's a testable tool, a new option for your toolkit to try against the very problem you just faced.",
  },
  {
    stepNumber: 4,
    title: "We Integrate and Rebuild Together",
    description:
      "You immediately return to the task-based game, now with the new tool. The goal isn't perfection — it's discovery. Does this help you control the situation better? Does it create the feeling you were missing? We repeat this cycle, refining your skill in the context where it must work: under pressure.",
  },
];

const comparisonItems = [
  {
    positive: "Real, transferable skill that works on any partner",
    negative: "Techniques that only work in drilling",
  },
  {
    positive: "The ability to coach yourself long after our sessions",
    negative: "Dependence on someone else's instruction",
  },
  {
    positive: 'Clearer understanding of Jiu-Jitsu\'s underlying "feel"',
    negative: "A collection of memorized steps",
  },
  {
    positive: "Engagement and curiosity in every roll",
    negative: "Frustration and stagnation",
  },
];

useSeoMeta({
  title:
    "BJJ Coaching — Feeling Stuck on the Mats? Let's Build Your Game Together.",
  description:
    "I coach Brazilian Jiu-Jitsu using Perceptual Control Theory and the Iterative Reorganization Method. Break through plateaus by learning to solve problems, not memorize moves.",
    ...
    <section class="py-14 md:py-16 bg-surface-raised/30">
      <div class="max-w-3xl mx-auto px-4">
        ...
        <div class="prose prose-lg max-w-none">
          <p>
            True Jiu-Jitsu intelligence isn't built by accumulating techniques.
            It's built by learning how to solve problems in real time — against
            unpredictable partners who are solving problems right back at you.
          </p>
          <p>
            I provide a supportive, focused space where we explore your game
            together, understand the real challenges beneath your frustrations,
            and create a clear path forward. You're not just receiving
            information; we're working as a team to rewire your instincts.
          </p>
        </div>
      </div>
    </section>
    ...
    <section class="py-16 md:py-20 bg-surface-raised/30">
      <div class="max-w-4xl mx-auto px-4">
        ...
        >
          ...
          solutions that fit your body and your game.
        </p>
      </div>
    </section>
