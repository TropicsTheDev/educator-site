...
<template>
  <div>
    <!-- Hero -->
    <section class="relative bg-gradient-to-br from-royal-purple/20 to-surface-base py-20 text-text-main">
        ...
        <div>
          ...
          <div class="space-y-6">
            ...
            <div v-if="settings?.socialLinks?.length">
              <h3 class="font-semibold text-text-main mb-3">Social</h3>
